...
const Reports = () => {
  ...
  // DELETE handler inside main component, updates reports list after deletion
  const handleDelete = async (reportId) => {
    try {
      await instance.delete(`/get-report/delete/${reportId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
              ...
              <div className="flex flex-col space-y-2">
                ...
                <div className="flex items-center justify-between w-full max-w-md">
                  <button
                    ...
                    className="text-green-700 hover:underline text-sm flex p gap-2"
                  >
